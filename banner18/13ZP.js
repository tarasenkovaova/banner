...
(lib._13ZP_300x250 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(127).to({_off:false},0).to({regX:0.2,regY:0.2,scaleX:0.79,scaleY:0.79,x:112.3,y:180.8,alpha:1},9).to({startPosition:0},31).wait(31));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(127).to({_off:false},0).to({regX:0.2,regY:0.2,scaleX:0.79,scaleY:0.79,x:47.8,y:180.2,alpha:1},9).to({startPosition:0},4).to({x:47.5},27).wait(31));
